...
var _Zone = __webpack_require__(1);
...
var Perry = exports.Perry = new (function () {
    function _class() {
        ...
        this.type = 'Perry';
        this.zone = new _Zone.Zone();
    } // constructor()

    _createClass(_class, [{
        key: 'createEntity',
        value: function createEntity() {
            return new _Entity.Entity();
        } // createEntity()
...
var Zone = exports.Zone = function Zone() {
...
var _Perry = __webpack_require__(0);
...
var _PSMath = __webpack_require__(4);
...
var Entity = exports.Entity = function () {
    ...
    _createClass(Entity, [{
        ...
        value: function fromString(s) {
            return this.fromJson(_PSMath.PSMath.lzw_decode(s));
        } // fromString()
